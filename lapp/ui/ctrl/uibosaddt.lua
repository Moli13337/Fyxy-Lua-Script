---
--- Created by BY.
--- DateTime: 2023/10/13 15:02:12
---
------------------------------------------------------------------
local LWnd = LWnd
---@class UIBosAddT:LWnd
local UIBosAddT = LxWndClass("UIBosAddT", LWnd)
...
function UIBosAddT:InitCommand()
...
function UIBosAddT:SetPos()
	...
	target2.localPosition = targetPos
	target.localPosition = targetPos
end

function UIBosAddT:OnTimer(key)
	self:SetPos()
end

function UIBosAddT:ListItem(list, item, itemdata, itemPos)
